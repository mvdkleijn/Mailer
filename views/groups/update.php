...
<form action="<?php echo get_url('plugin/mailer/groupUpdate'); ?>" method="post">
	...
	<table class="fieldset" cellpadding="0" cellspacing="0" border="0">
		...
		<tr>
			...
			<td class="field"><input type="submit" value="Update Group" /> or <a href="<?php echo get_url('plugin/mailer/groups'); ?>">cancel</a></td>
			<td></td>
		</tr>
	</table>
</form>