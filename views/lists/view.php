...
?>
	<li>
		<a href="<?php echo get_url('plugin/mailer/viewlist/'.$id.''); ?>#" title="<?php echo $month ?>: <?php echo $totalMonth ?> new subscribers">
